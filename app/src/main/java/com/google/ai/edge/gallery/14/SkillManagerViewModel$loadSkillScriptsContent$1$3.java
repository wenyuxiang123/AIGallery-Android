// Class: Lcom.google.ai.edge.gallery.customtasks.agentchat.SkillManagerViewModel$loadSkillScriptsContent$1$3
// Access: final
class SkillManagerViewModel$loadSkillScriptsContent$1$3 extends Lkotlin/coroutines/jvm/internal/SuspendLambda {

    // Methods:
    constructor void <init>(kotlin.jvm.functions.Function1, java.util.Map, kotlin.coroutines.Continuation) {
        // value = {
        // "(",
    ...
    public kotlin.coroutines.Continuation final create(java.lang.Object, kotlin.coroutines.Continuation) {
        ...
        // ">;"
        // }
        SkillManagerViewModel$loadSkillScriptsContent$1$3; v0 = new SkillManagerViewModel$loadSkillScriptsContent$1$3;();
        // DIRECT <init>(Lkotlin/jvm/functions/Function1;Ljava/util/Map;Lkotlin/coroutines/Continuation;)V
