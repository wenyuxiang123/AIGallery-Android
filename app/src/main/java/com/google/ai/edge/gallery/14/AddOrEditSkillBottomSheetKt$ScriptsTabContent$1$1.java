// Class: Lcom.google.ai.edge.gallery.customtasks.agentchat.AddOrEditSkillBottomSheetKt$ScriptsTabContent$1$1
// Access: final
class AddOrEditSkillBottomSheetKt$ScriptsTabContent$1$1 extends Lkotlin/coroutines/jvm/internal/SuspendLambda {

    // Methods:
    constructor void <init>(java.util.Map, java.lang.String, androidx.compose.runtime.MutableState, kotlin.coroutines.Continuation) {
        // value = {
        // "(",
        // "Ljava/util/Map<",
        // "Ljava/lang/String;",
    ...
    public kotlin.coroutines.Continuation final create(java.lang.Object, kotlin.coroutines.Continuation) {
        ...
        // ">;"
        // }
        AddOrEditSkillBottomSheetKt$ScriptsTabContent$1$1; v0 = new AddOrEditSkillBottomSheetKt$ScriptsTabContent$1$1;();
        // DIRECT <init>(Ljava/util/Map;Ljava/lang/String;Landroidx/compose/runtime/MutableState;Lkotlin/coroutines/Continuation;)V
    ...
    public java.lang.Object final invokeSuspend(java.lang.Object) {
        ...
        // if-nez v1, :cond_0
        // STATIC access$ScriptsTabContent$lambda$112(Landroidx/compose/runtime/MutableState;Ljava/lang/String;)V
