...
public final class MessageBodyBenchmarkLlmKt {
    ...
    public static final void MessageBodyBenchmarkLlm(final ChatMessageBenchmarkLlmResult message, Modifier modifier, Composer $composer, final int $changed, final int i) {
        final Modifier modifier2;
        Composer $composer2;
        Function0<ComposeUiNode> function0;
        Function0<ComposeUiNode> function02;
        Intrinsics.checkNotNullParameter(message, "message");
        Composer $composer3 = $composer.startRestartGroup(-1301743799);
        ComposerKt.sourceInformation($composer3, "C(MessageBodyBenchmarkLlm)36@1421L362:MessageBodyBenchmarkLlm.kt#ouynps");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
        ...
        if (!$composer3.shouldExecute(($dirty & 19) != 18, $dirty & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1301743799, $dirty, -1, "com.google.ai.edge.gallery.ui.common.chat.MessageBodyBenchmarkLlm (MessageBodyBenchmarkLlm.kt:35)");
            }
            Modifier modifier$iv = PaddingKt.m1988padding3ABfNKs(modifier3, C1654Dp.m9788constructorimpl(12));
            ...
            int i4 = ((48 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer3, -2143390252, "C38@1539L240:MessageBodyBenchmarkLlm.kt#ouynps");
            ...
            int i6 = ((54 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer3, -2007200648, "C:MessageBodyBenchmarkLlm.kt#ouynps");
            $composer3.startReplaceGroup(-1034579733);
            ComposerKt.sourceInformation($composer3, "*40@1682L83");
            Iterator<Stat> it = message.getOrderedStats().iterator();
            while (it.hasNext()) {
                Stat stat = it.next();
                DataCardKt.DataCard(stat.getLabel(), message.getStatValues().get(stat.getId()), stat.getUnit(), false, false, $composer3, 0, 24);
                it = it;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.google.ai.edge.gallery.ui.common.chat.MessageBodyBenchmarkLlmKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return MessageBodyBenchmarkLlmKt.MessageBodyBenchmarkLlm$lambda$2(message, modifier2, $changed, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
